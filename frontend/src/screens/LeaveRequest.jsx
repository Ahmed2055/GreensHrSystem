...
function LeaveRequest() {
    ...
    useEffect(()=>{
        if(natureLeave === 'Annual Leave'){setMaxDays(30)}
        if(natureLeave === 'Emergency Leave'){setMaxDays(14)}
        if(natureLeave === 'Hajj Leave'){setMaxDays(10)}
        if(natureLeave === 'Omrah Leave'){setMaxDays(5)}
    }, [natureLeave])
    ...
    useEffect(() => {
        ...
        if(realDays > maxDays){alert('Take Care, as the number of your leave days requested are more than the maximum number allowed, which may result in a Leave request rejection by the Administration.')}
    ...
    const submitLeaveRequest=(e)=>{
      ...
      console.log(newLeaveRequest);
        ...
        Axios.post('api/leaves/addALeave',newLeaveRequest)
      .then((response) => {
        ...
        <div className='leaveRequest'>
            ...
            <div className="payrollHistory__container">
                <div className="payrollHistory__title">
                    ...
                    <div className="payrollHistory__btnExpand" ><ExpandMoreIcon color='inherit' fontSize='large'  /></div>
                </div>
                ...
                <div className="leaveRequest__bodyContainer">
                    <div className="leaveRequest__bodyLeft">
                        ...
                        <div className="leaveRequest__Line">
                            <p className="lr__title">Nature of Leave <span className="red">*</span> </p>
                        ...
                        <div className="leaveRequest__Line">
                            <p className="lr__title">First Day of Leave <span className="red">*</span> </p> 
                            <div className="lr__detail"> <DatePicker selected={startLeaveDate} onChange={(date) => setStartLeaveDate(date)} /> </div>
                        </div>
                        <div className="leaveRequest__Line">
                            <p className="lr__title">Last Day of Leave <span className="red">*</span> </p> 
                            <div className="lr__detail"> <DatePicker selected={endLeaveDate} onChange={(date) => setEndLeaveDate(date)} /> </div>
                        </div>
                        <div className="leaveRequest__Line">
                            <p className="lr__title">Requested Days of Leave <span className="red">*</span> </p>
                            <span className="lr__detail lr__numDays"> {realDays} </span>
                        </div>
                        <div className="leaveRequest__Line">
                            <p className="lr__title">Maximum Return Date <span className="red">*</span> </p>
                            <div className="lr__detail"> <DatePicker selected={maximumReturnDate} onChange={()=>setMaxReturnDateChangeErr(true)} /> </div>
                        ...
                        <div className="leaveRequest__Line">
                            <p className="lr__title">Maximum Days of Leave <span className="red">*</span> </p>
                    ...
                    <div className="leaveRequest__bodyRight">
                        ...
                        <div className="leaveRequest__Line">
                            <p className="lr__title"> Leave Apply Date <span className="red">*</span> </p> 
                            <div className="lr__detail"> <DatePicker selected={leaveApplyDate} onChange={()=>setApplyDateChangeErr(true)} /> </div>
                            {applyDateChangeErr? <span className="lr__detail lr__error ">This value can't be changed</span> : ''}
                        </div>

                        <div className="leaveRequest__Line">
                            <p className="lr__title lr__longQu"> Are you travelling outside the country while on leave? <span className="red">*</span> </p> 
                            <div className="lr__detail"> <input value={outsideChecked} type="checkbox" onClick={()=>setOutsideChecked(!outsideChecked)} className="lr__checkBox"></input> </div>
                        </div>
                    </div>
                </div>

                <div className="leaveRequest__submitBtnDiv"> <button className="leaveRequest__submitBtn" type="submit" onClick={(e)=>submitLeaveRequest(e)}>Submit</button></div>
